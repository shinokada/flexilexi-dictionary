...
test('index page has expected meta description', async ({ page }) => {
  ...
  await expect(metaDescription).toHaveAttribute('content', 'A flexible dictionary for English, Norwegian, and Japanese.');
});

test('index page has expected meta keywords', async ({ page }) => {
  const metaKeywords = page.locator('meta[name="keywords"]');
  await expect(metaKeywords).toHaveAttribute('content', 'dictionary, language, learning, norwegian, japanese, english');
});
...
test('index page has expected meta og', async ({ page }) => {
  ...
  await expect(metaOgDescription).toHaveAttribute('content', 'A flexible dictionary for English, Norwegian, and Japanese.');
...
test('index page has expected meta twitter', async ({ page }) => {
  ...
  await expect(metaTwitterDescription).toHaveAttribute('content', 'A flexible dictionary for English, Norwegian, and Japanese.');
